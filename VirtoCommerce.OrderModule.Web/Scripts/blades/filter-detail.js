angular.module('virtoCommerce.orderModule')
    .controller('virtoCommerce.orderModule.filterDetailController', ['$scope', '$localStorage', 'virtoCommerce.orderModule.order_res_stores', 'platformWebApp.settings', 'virtoCommerce.customerModule.members', '$translate', 'virtoCommerce.orderModule.workflows', 'virtoCommerce.orderModule.statusTranslationService',
        function ($scope, $localStorage, order_res_stores, settings, members, $translate, workflows, statusTranslationService) {
            ...
            workflows.getStatuses({ id: blade.organizationId }, function (statuses) {
                statuses = statuses.data;
                if (statuses.length) {
                    blade.statuses = statusTranslationService.translateStatuses(statuses, 'customerOrder');
                } else {
