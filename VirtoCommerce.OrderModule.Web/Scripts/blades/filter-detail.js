angular.module('virtoCommerce.orderModule')
    .controller('virtoCommerce.orderModule.filterDetailController', ['$scope', '$localStorage', 'virtoCommerce.orderModule.order_res_stores', 'platformWebApp.settings', 'virtoCommerce.customerModule.members', '$translate', 'virtoCommerce.orderModule.statusTranslationService', 'virtoCommerce.orderModule.workflows',
        function ($scope, $localStorage, order_res_stores, settings, members, $translate, statusTranslationService, workflows) {
